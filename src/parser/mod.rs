...
impl<'a> Parser<'a> {
    ...
    fn reduce<const PRODUCTION: usize>(&mut self) -> Result<(), Error> {
        match PRODUCTION {
            ...
            67 => make_reduction_push!(self, 3, Exp, Exp, Binop, Exp),
            68 => make_reduction_push!(self, 2, Exp, Unop, Exp),
            69 => make_reduction_push!(self, 1, Prefixexp, Var),
            70 => make_reduction_push!(self, 1, Prefixexp, Functioncall),
            71 => make_reduction_push!(self, 1, Prefixexp, LParen, Exp, RParen),
            72 => make_reduction_push!(self, 2, Functioncall, Prefixexp, Args),
            73 => make_reduction_push!(self, 4, Functioncall, Prefixexp, Colon, Name, Args),
            74 => make_reduction_push!(self, 3, Args, LParen, ArgsExplist, RParen),
            75 => make_reduction_push!(self, ArgsExplist),
            76 => make_reduction_push!(self, 1, ArgsExplist, Explist),
            77 => make_reduction_push!(self, 1, Args, Tableconstructor),
            78 => make_reduction_push!(self, 1, Args, String),
            79 => make_reduction_push!(self, 2, Functiondef, Function, Funcbody),
            80 => {
                make_reduction_push!(
                    self,
                    5,
            ...
            81 => make_reduction_push!(self, FuncbodyParlist),
            82 => make_reduction_push!(self, 1, FuncbodyParlist, Parlist),
            83 => make_reduction_push!(self, 2, Parlist, Namelist, ParlistCont),
            84 => make_reduction_push!(self, ParlistCont),
            85 => make_reduction_push!(self, 3, ParlistCont, Comma, Name, ParlistCont),
            86 => make_reduction_push!(self, 2, ParlistCont, Comma, Dots),
            87 => make_reduction_push!(self, 1, Parlist, Dots),
            88 => {
                make_reduction_push!(
                    self,
                    3,
            ...
            89 => make_reduction_push!(self, TableconstructorFieldlist),
            90 => make_reduction_push!(self, 1, TableconstructorFieldlist, Fieldlist),
            91 => make_reduction_push!(self, 2, Fieldlist, Field, FieldlistCont),
            92 => make_reduction_push!(self, FieldlistCont),
            93 => make_reduction_push!(self, 3, FieldlistCont, Fieldsep, Field, FieldlistCont),
            94 => make_reduction_push!(self, 1, FieldlistCont, Fieldsep),
            95 => make_reduction_push!(self, 5, Field, LSquare, Exp, RSquare, Assign, Exp),
            96 => make_reduction_push!(self, 3, Field, Name, Assign, Exp),
            97 => make_reduction_push!(self, 1, Field, Exp),
            98 => make_reduction_push!(self, 1, Fieldsep, Comma),
            99 => make_reduction_push!(self, 1, Fieldsep, SemiColon),
            100 => make_reduction_push!(self, 1, Binop, Or),
            101 => make_reduction_push!(self, 1, Binop, And),
            102 => make_reduction_push!(self, 1, Binop, Less),
            103 => make_reduction_push!(self, 1, Binop, Greater),
            104 => make_reduction_push!(self, 1, Binop, Leq),
            105 => make_reduction_push!(self, 1, Binop, Geq),
            106 => make_reduction_push!(self, 1, Binop, Eq),
            107 => make_reduction_push!(self, 1, Binop, Neq),
            108 => make_reduction_push!(self, 1, Binop, BitOr),
            109 => make_reduction_push!(self, 1, Binop, BitXor),
            110 => make_reduction_push!(self, 1, Binop, BitAnd),
            111 => make_reduction_push!(self, 1, Binop, ShiftL),
            112 => make_reduction_push!(self, 1, Binop, ShiftR),
            113 => make_reduction_push!(self, 1, Binop, Concat),
            114 => make_reduction_push!(self, 1, Binop, Add),
            115 => make_reduction_push!(self, 1, Binop, Sub),
            116 => make_reduction_push!(self, 1, Binop, Mul),
            117 => make_reduction_push!(self, 1, Binop, Div),
            118 => make_reduction_push!(self, 1, Binop, Idiv),
            119 => make_reduction_push!(self, 1, Binop, Mod),
            120 => make_reduction_push!(self, 1, Binop, Pow),
            121 => make_reduction_push!(self, 1, Unop, Not),
            122 => make_reduction_push!(self, 1, Unop, Len),
            123 => make_reduction_push!(self, 1, Unop, Sub),
            124 => make_reduction_push!(self, 1, Unop, BitXor),
            _ => {
                unreachable!()
            }
        }
