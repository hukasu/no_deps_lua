    ...
    pub fn parse(program: &'a str) -> Result<Token<'a>, Error> {
        ...
        loop {
            match parser.state() {
                ...
                // State 15
                make_state!(15, Assign) => parser.shift(73),
                // State 16
                ...
                make_state!(16, LParen) => parser.reduce::<8>()?, // Reduce(8)-Reduce(93) resolved by reducing by the first production
                ...
                make_state!(18, Assign) => parser.reduce::<46>()?,
                make_state!(18, LParen) => parser.reduce::<92>()?,
                make_state!(18, LSquare) => parser.reduce::<92>()?,
                make_state!(18, LCurly) => parser.reduce::<92>()?,
                make_state!(18, Colon) => parser.reduce::<92>()?,
                make_state!(18, Comma) => parser.shift(37),
                make_state!(18, Dot) => parser.reduce::<92>()?,
                make_state!(18, VarlistCont) => parser.goto(32),
                // State 19
                make_state!(19, String) => parser.reduce::<48>()?,
                make_state!(19, Assign) => parser.reduce::<48>()?,
                make_state!(19, LParen) => parser.reduce::<48>()?,
                make_state!(19, LSquare) => parser.reduce::<48>()?,
                make_state!(19, LCurly) => parser.reduce::<48>()?,
                make_state!(19, Colon) => parser.reduce::<48>()?,
                make_state!(19, Comma) => parser.reduce::<48>()?,
                make_state!(19, Dot) => parser.reduce::<48>()?,
                // State 20
                ...
                // State 32
                make_state!(32, Assign) => parser.reduce::<45>()?,
                // State 34
                ...
                // State 73
                make_state!(73, Name) => parser.shift(176),
                make_state!(73, String) => parser.shift(237),
                make_state!(73, Integer) => parser.shift(238),
                make_state!(73, Float) => parser.shift(239),
                make_state!(73, False) => parser.shift(240),
                make_state!(73, Function) => parser.shift(428),
                make_state!(73, Nil) => parser.shift(241),
                make_state!(73, Not) => parser.shift(247),
                make_state!(73, True) => parser.shift(336),
                make_state!(73, Sub) => parser.shift(338),
                make_state!(73, Len) => parser.shift(393),
                make_state!(73, BitXor) => parser.shift(404),
                make_state!(73, LParen) => parser.shift(420),
                make_state!(73, LCurly) => parser.shift(430),
                make_state!(73, Dots) => parser.shift(414),
                make_state!(73, Var) => parser.goto(425),
                make_state!(73, Explist) => parser.goto(172),
                make_state!(73, Exp) => parser.goto(232),
                make_state!(73, Prefixexp) => parser.goto(183),
                make_state!(73, Functioncall) => parser.goto(426),
                make_state!(73, Functiondef) => parser.goto(418),
                make_state!(73, Tableconstructor) => parser.goto(419),
                // State 84
                ...
                make_state!(86, String) => parser.shift(219),
                ...
                // State 172
                make_state!(172, Name) => parser.reduce::<7>()?,
                make_state!(172, Break) => parser.reduce::<7>()?,
                make_state!(172, Do) => parser.reduce::<7>()?,
                make_state!(172, For) => parser.reduce::<7>()?,
                make_state!(172, Function) => parser.reduce::<7>()?,
                make_state!(172, Goto) => parser.reduce::<7>()?,
                make_state!(172, If) => parser.reduce::<7>()?,
                make_state!(172, Local) => parser.reduce::<7>()?,
                make_state!(172, Repeat) => parser.reduce::<7>()?,
                make_state!(172, Return) => parser.reduce::<7>()?,
                make_state!(172, While) => parser.reduce::<7>()?,
                make_state!(172, LParen) => parser.reduce::<7>()?,
                make_state!(172, DoubleColon) => parser.reduce::<7>()?,
                make_state!(172, SemiColon) => parser.reduce::<7>()?,
                make_state!(172, Eof) => parser.reduce::<7>()?,
                // State 176
                ...
                // State 238
                make_state!(238, Name) => parser.reduce::<61>()?,
                make_state!(238, And) => parser.reduce::<61>()?,
                make_state!(238, Break) => parser.reduce::<61>()?,
                make_state!(238, Do) => parser.reduce::<61>()?,
                make_state!(238, For) => parser.reduce::<61>()?,
                make_state!(238, Function) => parser.reduce::<61>()?,
                make_state!(238, Goto) => parser.reduce::<61>()?,
                make_state!(238, If) => parser.reduce::<61>()?,
                make_state!(238, Local) => parser.reduce::<61>()?,
                make_state!(238, Or) => parser.reduce::<61>()?,
                make_state!(238, Repeat) => parser.reduce::<61>()?,
                make_state!(238, Return) => parser.reduce::<61>()?,
                make_state!(238, While) => parser.reduce::<61>()?,
                make_state!(238, Add) => parser.reduce::<61>()?,
                make_state!(238, Sub) => parser.reduce::<61>()?,
                make_state!(238, Mul) => parser.reduce::<61>()?,
                make_state!(238, Div) => parser.reduce::<61>()?,
                make_state!(238, Idiv) => parser.reduce::<61>()?,
                make_state!(238, Mod) => parser.reduce::<61>()?,
                make_state!(238, Pow) => parser.reduce::<61>()?,
                make_state!(238, BitAnd) => parser.reduce::<61>()?,
                make_state!(238, BitXor) => parser.reduce::<61>()?,
                make_state!(238, BitOr) => parser.reduce::<61>()?,
                make_state!(238, ShiftL) => parser.reduce::<61>()?,
                make_state!(238, ShiftR) => parser.reduce::<61>()?,
                make_state!(238, Eq) => parser.reduce::<61>()?,
                make_state!(238, Neq) => parser.reduce::<61>()?,
                make_state!(238, Leq) => parser.reduce::<61>()?,
                make_state!(238, Geq) => parser.reduce::<61>()?,
                make_state!(238, Less) => parser.reduce::<61>()?,
                make_state!(238, Greater) => parser.reduce::<61>()?,
                make_state!(238, LParen) => parser.reduce::<61>()?,
                make_state!(238, DoubleColon) => parser.reduce::<61>()?,
                make_state!(238, SemiColon) => parser.reduce::<61>()?,
                make_state!(238, Comma) => parser.reduce::<61>()?,
                make_state!(238, Concat) => parser.reduce::<61>()?,
                make_state!(238, Eof) => parser.reduce::<61>()?,
                // State 242
