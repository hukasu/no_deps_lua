...
impl<'a> Parser<'a> {
    ...
    fn reduce<const PRODUCTION: usize>(&mut self) -> Result<(), Error> {
        match PRODUCTION {
            0 => make_reduction_push!(self, Chunk, 1, Block),
            1 => make_reduction_push!(self, Block, 2, BlockStat, BlockRetstat),
            2 => make_reduction_push!(self, BlockStat),
            3 => make_reduction_push!(self, BlockStat, 2, Stat, BlockStat),
            4 => make_reduction_push!(self, BlockRetstat),
            5 => make_reduction_push!(self, BlockRetstat, 1, Retstat),
            6 => make_reduction_push!(self, Stat, 1, SemiColon),
            7 => make_reduction_push!(self, Stat, 3, Varlist, Assign, Explist),
            8 => make_reduction_push!(self, Stat, 1, Functioncall),
            9 => make_reduction_push!(self, Stat, 1, Label),
            10 => make_reduction_push!(self, Stat, 1, Break),
            11 => make_reduction_push!(self, Stat, 2, Goto, Name),
            12 => make_reduction_push!(self, Stat, 3, Do, Block, End),
            13 => make_reduction_push!(self, Stat, 5, While, Exp, Do, Block, End),
            14 => make_reduction_push!(self, Stat, 4, Repeat, Block, Until, Exp),
            15 => {
                make_reduction_push!(self, Stat, 6, If, Exp, Then, Block, StatIf, End)
            }
            16 => make_reduction_push!(self, StatIf),
            17 => make_reduction_push!(self, StatIf, 5, Elseif, Exp, Then, Block, StatIf),
            18 => make_reduction_push!(self, StatIf, 2, Else, Block),
            19 => {
                make_reduction_push!(
                    self, Stat, 10, For, Name, Assign, Exp, Comma, Exp, StatForexp, Do, Block, End
                )
            }
            20 => make_reduction_push!(self, StatForexp),
            21 => make_reduction_push!(self, StatForexp, 2, Comma, Exp),
            22 => make_reduction_push!(self, Stat, 7, For, Namelist, In, Explist, Do, Block, End),
            23 => make_reduction_push!(self, Stat, 3, Function, Funcname, Funcbody),
            24 => make_reduction_push!(self, Stat, 4, Local, Function, Name, Funcbody),
            25 => make_reduction_push!(self, Stat, 3, Local, Attnamelist, StatAttexplist),
            26 => make_reduction_push!(self, StatAttexplist),
            27 => make_reduction_push!(self, StatAttexplist, 2, Assign, Explist),
            28 => make_reduction_push!(self, Attnamelist, 3, Name, Attrib, AttnamelistCont),
            29 => make_reduction_push!(self, AttnamelistCont),
            30 => {
                make_reduction_push!(
                    self,
                    AttnamelistCont,
            ...
            31 => make_reduction_push!(self, Attrib),
            32 => make_reduction_push!(self, Attrib, 3, Less, Name, Greater),
            33 => make_reduction_push!(self, Retstat, 3, Return, RetstatExplist, RetstatEnd),
            34 => make_reduction_push!(self, RetstatExplist),
            35 => make_reduction_push!(self, RetstatExplist, 1, Explist),
            36 => make_reduction_push!(self, RetstatEnd),
            37 => make_reduction_push!(self, RetstatEnd, 1, SemiColon),
            38 => make_reduction_push!(self, Label, 3, DoubleColon, Name, DoubleColon),
            39 => make_reduction_push!(self, Funcname, 3, Name, FuncnameCont, FuncnameEnd),
            40 => make_reduction_push!(self, FuncnameCont),
            41 => make_reduction_push!(self, FuncnameCont, 3, Dot, Name, FuncnameCont),
            42 => make_reduction_push!(self, FuncnameEnd),
            43 => make_reduction_push!(self, FuncnameEnd, 2, Colon, Name),
            44 => make_reduction_push!(self, Varlist, 2, Var, VarlistCont),
            45 => make_reduction_push!(self, VarlistCont),
            46 => make_reduction_push!(self, VarlistCont, 3, Comma, Var, VarlistCont),
            47 => make_reduction_push!(self, Var, 1, Name),
            48 => make_reduction_push!(self, Var, 4, Prefixexp, LSquare, Exp, RSquare),
            49 => make_reduction_push!(self, Var, 3, Prefixexp, Dot, Name),
            50 => make_reduction_push!(self, Namelist, 2, Name, NamelistCont),
            51 => make_reduction_push!(self, NamelistCont),
            52 => make_reduction_push!(self, NamelistCont, 3, Comma, Name, NamelistCont),
            53 => make_reduction_push!(self, Explist, 2, Exp, ExplistCont),
            54 => make_reduction_push!(self, ExplistCont),
            55 => make_reduction_push!(self, ExplistCont, 3, Comma, Exp, ExplistCont),
            56 => make_reduction_push!(self, Exp, 1, Nil),
            57 => make_reduction_push!(self, Exp, 1, False),
            58 => make_reduction_push!(self, Exp, 1, True),
            59 => make_reduction_push!(self, Exp, 1, String),
            60 => make_reduction_push!(self, Exp, 1, Integer),
            61 => make_reduction_push!(self, Exp, 1, Float),
            62 => make_reduction_push!(self, Exp, 1, Dots),
            63 => make_reduction_push!(self, Exp, 1, Functiondef),
            64 => make_reduction_push!(self, Exp, 1, Prefixexp),
            65 => make_reduction_push!(self, Exp, 1, Tableconstructor),
            66 => make_reduction_push!(self, Exp, 3, Exp, Binop, Exp),
            67 => make_reduction_push!(self, Exp, 2, Unop, Exp),
            68 => make_reduction_push!(self, Prefixexp, 1, Var),
            69 => make_reduction_push!(self, Prefixexp, 1, Functioncall),
            70 => make_reduction_push!(self, Prefixexp, 1, LParen, Exp, RParen),
            71 => make_reduction_push!(self, Functioncall, 2, Prefixexp, Args),
            72 => make_reduction_push!(self, Functioncall, 4, Prefixexp, Colon, Name, Args),
            73 => make_reduction_push!(self, Args, 3, LParen, ArgsExplist, RParen),
            74 => make_reduction_push!(self, ArgsExplist),
            75 => make_reduction_push!(self, ArgsExplist, 1, Explist),
            76 => make_reduction_push!(self, Args, 1, Tableconstructor),
            77 => make_reduction_push!(self, Args, 1, String),
            78 => make_reduction_push!(self, Functiondef, 2, Function, Funcbody),
            79 => {
                make_reduction_push!(
                    self,
                    Funcbody,
            ...
            80 => make_reduction_push!(self, FuncbodyParlist),
            81 => make_reduction_push!(self, FuncbodyParlist, 1, Parlist),
            82 => make_reduction_push!(self, Parlist, 2, Namelist, ParlistCont),
            83 => make_reduction_push!(self, ParlistCont),
            84 => make_reduction_push!(self, ParlistCont, 3, Comma, Name, ParlistCont),
            85 => make_reduction_push!(self, ParlistCont, 2, Comma, Dots),
            86 => make_reduction_push!(self, Parlist, 1, Dots),
            87 => {
                make_reduction_push!(
                    self,
                    Tableconstructor,
            ...
            88 => make_reduction_push!(self, TableconstructorFieldlist),
            89 => make_reduction_push!(self, TableconstructorFieldlist, 1, Fieldlist),
            90 => make_reduction_push!(self, Fieldlist, 2, Field, FieldlistCont),
            91 => make_reduction_push!(self, FieldlistCont),
            92 => make_reduction_push!(self, FieldlistCont, 3, Fieldsep, Field, FieldlistCont),
            93 => make_reduction_push!(self, FieldlistCont, 1, Fieldsep),
            94 => make_reduction_push!(self, Field, 5, LSquare, Exp, RSquare, Assign, Exp),
            95 => make_reduction_push!(self, Field, 3, Name, Assign, Exp),
            96 => make_reduction_push!(self, Field, 1, Exp),
            97 => make_reduction_push!(self, Fieldsep, 1, Comma),
            98 => make_reduction_push!(self, Fieldsep, 1, SemiColon),
            99 => make_reduction_push!(self, Binop, 1, Or),
            100 => make_reduction_push!(self, Binop, 1, And),
            101 => make_reduction_push!(self, Binop, 1, Less),
            102 => make_reduction_push!(self, Binop, 1, Greater),
            103 => make_reduction_push!(self, Binop, 1, Leq),
            104 => make_reduction_push!(self, Binop, 1, Geq),
            105 => make_reduction_push!(self, Binop, 1, Eq),
            106 => make_reduction_push!(self, Binop, 1, Neq),
            107 => make_reduction_push!(self, Binop, 1, BitOr),
            108 => make_reduction_push!(self, Binop, 1, BitXor),
            109 => make_reduction_push!(self, Binop, 1, BitAnd),
            110 => make_reduction_push!(self, Binop, 1, ShiftL),
            111 => make_reduction_push!(self, Binop, 1, ShiftR),
            112 => make_reduction_push!(self, Binop, 1, Concat),
            113 => make_reduction_push!(self, Binop, 1, Add),
            114 => make_reduction_push!(self, Binop, 1, Sub),
            115 => make_reduction_push!(self, Binop, 1, Mul),
            116 => make_reduction_push!(self, Binop, 1, Div),
            117 => make_reduction_push!(self, Binop, 1, Idiv),
            118 => make_reduction_push!(self, Binop, 1, Mod),
            119 => make_reduction_push!(self, Binop, 1, Pow),
            120 => make_reduction_push!(self, Unop, 1, Not),
            121 => make_reduction_push!(self, Unop, 1, Len),
            122 => make_reduction_push!(self, Unop, 1, Sub),
            123 => make_reduction_push!(self, Unop, 1, BitXor),
            _ => {
                unreachable!()
            }
        }
