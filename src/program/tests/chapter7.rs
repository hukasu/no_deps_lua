...
"#,
    ...
    assert_eq!(
        ...
        &[
            ...
            // g2 = 2
            ByteCode::SetUpTableConstant(0, 2, 3),
            // if g1 or g2 and g3 then
            ...
            ByteCode::Jmp(3),
            //     print "test only once"
            ByteCode::GetUpTable(0, 0, 5),
            ByteCode::LoadConstant(1, 6),
            ByteCode::Call(0, 2, 1),
            // end
